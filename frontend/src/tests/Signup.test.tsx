...
describe("Signup", () => {
    test("shows errors when submitting empty form", async () => {
        ...
        const usernameError = screen.getByRole("paragraph", {
            name: /username error/i,
        });
        const emailError = screen.getByRole("paragraph", {
            name: /email error/i,
        });
        const passwordError = screen.getByRole("paragraph", {
            name: /password error/i,
        });
